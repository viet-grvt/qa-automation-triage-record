# Messages ready to post — 18/08/2026
...
|---|---|---|---|
| 1.1–1.6 | [Triage record — #qa-web-automation-prod](posts/1-triage-web-prod.md) | #qa-web-automation-prod — thread of the 05:50 run | ready |
| 1.1–1.6 | [Triage record — #qa-web-automation-testnet](posts/1-triage-web-testnet.md) | #qa-web-automation-testnet — thread of the 12:19 run | ready |
| 1.1–1.6 | [Triage record — #qa-web-automation-staging](posts/1-triage-web-staging.md) | #qa-web-automation-staging — thread of the 12:51 run | ready |
| 1.1–1.6 | [Triage record — #qa-mobile-automation-testnet](posts/1-triage-mobile-testnet.md) | #qa-mobile-automation-testnet — thread of the 09:49 run | ready |
